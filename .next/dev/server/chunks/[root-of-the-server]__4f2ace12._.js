...
"[project]/app/api/send-hearing-test-results/route.tsx [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!customerData || !testResults) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Missing customer data or test results"
            }, {
                status: 400
            });
        }
        if (!process.env.RESEND_API_KEY) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                details: "RESEND_API_KEY environment variable is missing. Please add it to your Vercel project environment variables or local .env.local file.",
                setupRequired: true
            }, {
                status: 500
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f2ace12._.js.map